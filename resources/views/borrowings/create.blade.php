@extends('layouts.app')
@section('title', 'Pievienot aizņēmumu')

@section('content')
    <h1 class="text-2xl font-bold mb-4">Pievienot aizņēmumu</h1>
    ...
    <form action="{{ route('borrowings.store') }}" method="POST" class="bg-white rounded shadow p-6 max-w-lg">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="borrowed_at" value="{{ old('borrowed_at', date('Y-m-d')) }}" class="w-full border rounded px-3 py-2" required>
